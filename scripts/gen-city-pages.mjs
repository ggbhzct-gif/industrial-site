...
const CITIES = [
  { slug:"shanghai",  name:"上海",   prov:"上海市", geo:"CN-31",
    ...
    caseNote:"浦东某汽车零部件厂产线升级，单次回收 S11-630kVA 油浸变压器 2 台 + 约 3.8 吨 YJV 铜芯电缆，24 小时内完成过磅结算。" },
  { slug:"suzhou",    name:"苏州",   prov:"江苏省", geo:"CN-32",
    ...
    caseNote:"吴江某光伏组件工厂整厂搬迁，回收 SCB10 干式变压器 4 台 + 约 12 吨铜芯电缆 + GGD 开关柜 8 面，3 日完成清场。" },
  { slug:"kunshan",   name:"昆山",   prov:"江苏省", geo:"CN-32",
    ...
    caseNote:"花桥某笔记本代工厂扩产，回收旧配电柜 6 面 + SCB10-800kVA 干式变压器 1 台，当日完成评估与运输。" },
  { slug:"wuxi",      name:"无锡",   prov:"江苏省", geo:"CN-32",
    ...
    caseNote:"江阴某特钢企业变电站改造，回收 S9-1600kVA 油浸变压器 2 台 + YJV22 10kV 高压电缆约 800 米。" },
  { slug:"changzhou", name:"常州",   prov:"江苏省", geo:"CN-32",
    ...
    caseNote:"武进某动力电池企业产线升级，回收 SCB13-1250kVA 干式变压器 3 台 + 母线槽约 200 米 + 铜芯电缆约 5 吨。" },
  { slug:"nanjing",   name:"南京",   prov:"江苏省", geo:"CN-32",
    ...
    caseNote:"江宁某大型电子厂变电所改造，回收 S11-2000kVA 油浸变压器 2 台 + 35kV 高压电缆 600 米 + 开关柜 12 面。" },
  { slug:"hangzhou",  name:"杭州",   prov:"浙江省", geo:"CN-33",
    ...
    caseNote:"钱塘区某数据中心扩容，旧 SCB10 干式变压器 6 台 + 铜芯电力电缆约 8 吨整批回收。" },
  { slug:"ningbo",    name:"宁波",   prov:"浙江省", geo:"CN-33",
    ...
    caseNote:"北仑某港口机械厂改造，回收 10kV 高压电缆约 1.5 公里 + S9 油浸变压器 3 台。" },
  { slug:"jiaxing",   name:"嘉兴",   prov:"浙江省", geo:"CN-33",
    ...
    caseNote:"嘉善某光伏配件厂扩产，新采购 SCB13-1000kVA 干式变压器 2 台（从本司二手库调配）+ 回收旧 S9 变压器 1 台。" },
  { slug:"huzhou",    name:"湖州",   prov:"浙江省", geo:"CN-33",
    ...
    caseNote:"长兴某电池企业老厂区退出，整厂回收干式变压器 5 台 + 铜芯电缆 15 吨 + 配电柜 20 面。" },
  { slug:"hefei",     name:"合肥",   prov:"安徽省", geo:"CN-34",
    ...
    caseNote:"长丰下塘某新能源汽车产业园配套工程，回收 SCB13 干式变压器 4 台 + 铜芯电力电缆约 10 吨，现场过磅结算。" },
  { slug:"wuhu",      name:"芜湖",   prov:"安徽省", geo:"CN-34",
    ...
    caseNote:"芜湖经开区某汽车零部件厂产线调整，回收 S11-1000kVA 油浸变压器 2 台 + 铝芯电缆约 4 吨。" },
...
const SERVICES_HUB = [
  {
    ...
    title: "废旧电缆回收（长三角及安徽）· 铜芯 / 铝芯 / 高压电缆上门高价回收 | 新兴电力设备",
    h1html: "<em>废旧电缆</em>回收<br/>铜芯 · 铝芯 · 高压电缆",
    desc: "长三角及安徽区域废旧电缆上门高价回收：铜芯 YJV / 铝芯 YJLV / 10kV·35kV 高压交联电缆 / 低压电力电缆 / 控制电缆 / 电机引出线。按净铜铝 × 当日长江有色金属价 × 回收系数结算，现场过磅，正规单据。",
    kw: [
    ...
    sections: [
      {
        ...
        grid: [
          ["铜芯电力电缆", "YJV、YJV22、VV、VV22 等铜芯电力电缆，按净铜重量结算，价格参考当日长江铜现货。"],
          ["铝芯电力电缆", "YJLV、YJLV22、VLV 等铝芯电力电缆，按净铝重量结算，价格参考当日长江铝现货。"],
      ...
      {
        h2: "价格怎么算（计价公式）",
        lead: "报价透明，杜绝口头压价。核心公式与铜/铝市场挂钩。",
        grid: [
          ["铜芯电缆","单价 ≈ 净铜重量 × 当日长江铜价 × 回收系数（含税/不含税另议）"],
          ["铝芯电缆","单价 ≈ 净铝重量 × 当日长江铝价 × 回收系数"],
          ["高压交联","大截面高压电缆铜含量占比高，可按接近纯铜回收"],
          ["未剥皮毛收","按电缆毛重 × 铜含量折算系数，适用大批量无法剥皮场景"],
        ],
      },
      {
        h2: "上门回收流程",
...
const commonFaqs = [
  { q: "废旧电缆回收价格怎么算？",       a: "按净铜/净铝重量 × 当日长江有色金属价 × 回收系数综合评估。铜芯电缆价格约为铝芯的 3–4 倍。建议拍照发微信，10 分钟内给出初步价格区间。" },
...
<main>
  ...
  <section><div class="wrap">
    ...
    <h2>${c.name}三大核心业务</h2>
    <p class="lead">覆盖电气设备全生命周期处置与流通——点击查看完整业务说明与价格公式。</p>
    <div class="cross-links">
      <a href="/cable-recycling/"><b>▸ ${c.name}废旧电缆回收 →</b><span>铜芯 / 铝芯 / 高压电缆，按净金属 × 铜铝价 × 回收系数结算</span></a>
