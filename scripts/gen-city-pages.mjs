...
const CITIES = [
  ...
  { slug:"chuzhou",   name:"滁州",   prov:"安徽省", geo:"CN-34",
    ...
    caseNote:"滁州典型场景：轨道交通装备、家电配套、仪表电缆企业的扩产或退租，常见处置对象为 SCB 干式变压器、S 系列油浸变压器、高低压柜和电力电缆。" },
...
const SERVICES_HUB = [
  {
    ...
    sections: [
      ...
      {
        h2: "上门回收流程",
        lead: "从资料确认到结算共 5 步，具体时间按数量、位置和现场条件确认。",
        grid: [
          ["1. 微信发图","拍摄铭牌/实物图 + 估重 → 微信发给我们"],
          ["2. 初步报价","收到资料后给出初步价格范围，并说明报价依据"],
          ["3. 上门看货","结合城市、数量和现场条件确认上门时间"],
          ["4. 过磅称重","现场过磅、复核规格、双方确认"],
          ["5. 结算交接","按双方确认的合同或交接单完成结算"],
        ],
      },
    ],
    faq: [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        h2: "出售：二手库存对接",
        lead: "可根据实际库存和客户参数需求，对接 SCB10、SCB13、S11、S13 等常见型号。",
        grid: [
          ["适合场景","产线扩容、应急备机、低成本上电、临时工地"],
          ["验货流程","现场查看铭牌 / 绝缘耐压 / 历史检测报告"],
          ["交易约定","根据检测结果、设备状态和双方合同确认验收与售后范围"],
          ["运输","可根据设备尺寸、重量和目的地协调运输方案"],
        ],
      },
    ],
    faq: [
      ...
      { q:"油浸式变压器油怎么处理？", a:"处置前应确认变压器油状态、现场环保要求和交接责任；涉及危废属性时，应由具备相应条件的单位按当地规定处理并留存记录。" },
      ...
      { q:"能提供过户 / 资产处置单据吗？", a:"可在交易前明确设备清单、交接记录、结算凭证和票据要求，实际提供内容以交易主体条件及合同约定为准。" },
    ],
  },
  {
    ...
    sections: [
      {
        ...
        grid: [
          ...
          ["企业/园区资产处置","按合同约定提供设备清单、交接记录和结算凭证"],
          ["限期腾退","根据清场范围、施工条件和排期制定进场计划"],
        ],
      },
      {
        h2: "打包处置的主要设备",
      ...
      {
        h2: "标准作业流程",
        lead: "施工范围、安全条件、人员资格和交接记录应在进场前逐项确认。",
        grid: [
          ["1. 项目踏勘","符合上门条件的项目预约查看，确认设备清单和处置范围"],
          ["2. 分类估价","按回收 / 残值 / 报废三类分别评估，出具总价"],
          ["3. 安全拆除","进场前核验作业人员和施工条件，按停电、验电、接地等要求执行"],
          ["4. 过磅装车","现场磅单、照片留档、影像可追溯"],
          ["5. 结算 & 单据","签署交接记录，按合同约定完成结算并提供相应凭证"],
          ["6. 场地清理","场地清扫、垃圾清运，交付一个干净的空场地"],
        ],
      },
    ],
    faq: [
      { q:"工厂搬迁整体设备能一起处理吗？", a:"可以先对变压器、开关柜、母线槽、电机水泵、电缆线路和金属支架进行清点，再根据现场条件确定打包评估与清场方案。" },
      { q:"拆除施工需要核验哪些条件？", a:"进场前应核验作业人员资格、停电条件、高空或吊装要求、施工边界和企业安全管理规定，具体以项目现场和合同约定为准。" },
      { q:"有大项目是否需要先签合同？", a:"需要。10 万元以上的项目建议签署正式回收 / 拆除合同，明确范围、价格、周期、安全、付款条款，降低双方风险。" },
      { q:"能提供处置单据用于资产留档吗？", a:"可在合同中明确设备清单、过磅单、现场照片、交接记录、结算凭证和票据要求，实际提供内容以项目约定为准。" },
      { q:"老厂房整体拆除也做吗？", a:"电气设备部分我们直接承接；土建拆除、厂房钢结构拆除我们有合作方对接，可出统一方案。" },
      { q:"招投标或公开处置项目怎么对接？", a:"应先核对项目公告中的主体资格、保证金、现场踏勘、合同和档案要求，确认满足条件后再按项目流程报名。" },
    ],
  },
];
...
const GUIDE_PAGES = [
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "能提供资产处置留档吗？", a: "可根据项目约定整理交接清单、过磅单、现场照片和结算凭证，票据要求需在交易前确认。" },
    ],
  },
  {
    slug: "guides/anhui-cable-recycling",
    title: "安徽废旧电缆回收怎么找_合肥芜湖马鞍山滁州上门评估 | 新兴电力设备",
    h1: "安徽废旧电缆回收怎么找",
    desc: "安徽废旧电缆回收适合先拍铭牌、线缆截面、现场堆放和装车条件，再按铜芯或铝芯、规格、重量、拆除难度和运输距离综合评估。覆盖合肥、芜湖、马鞍山、滁州、铜陵、安庆等地。",
    kw: ["安徽废旧电缆回收","合肥废旧电缆回收","芜湖电缆回收","马鞍山电缆回收","滁州废旧电缆回收","安徽铜芯电缆回收"],
    service: "废旧电缆回收",
    serviceUrl: "/cable-recycling/",
    sections: [
      {
        h2: "安徽地区电缆回收先看哪些信息",
        lead: "安徽工厂、园区、工地的电缆处置，通常先判断材质和数量，再看是否需要拆除、吊装、叉车和整车清运。",
        grid: [
          ["芯材", "先分清铜芯、铝芯、控制线、通信线，铜铝不要混放报价。"],
          ["规格", "拍清 YJV、YJLV、YJV22、KVV 等型号，以及截面和电压等级。"],
          ["数量", "提供大致米数、卷数、盘数或估重，判断是否值得单独上门。"],
          ["现场", "说明城市、园区、楼层、装车距离、是否需要拆桥架或管廊旧线。"],
        ],
      },
      {
        h2: "哪些安徽城市适合直接上门",
        lead: "合肥、芜湖、马鞍山、滁州及周边工业园区项目密度高，量大项目可优先安排。",
        grid: [
          ["合肥", "经开区、高新区、新桥科学城、肥西、长丰等工厂扩产和配电改造项目。"],
          ["芜湖", "芜湖经开区、三山、鸠江、无为等汽车、装备和电缆相关产业项目。"],
          ["马鞍山", "当涂、博望、郑蒲港、雨山等重工和机械加工项目。"],
          ["滁州", "来安汊河、全椒、天长、滁州经开区等承接南京产业转移项目。"],
        ],
      },
    ],
    faq: [
      { q: "安徽废旧电缆回收需要提前剥皮吗？", a: "不一定。量大可按毛重和抽样折算评估，是否剥皮要看线缆规格、现场条件和客户是否追求更高单价。" },
      { q: "合肥、芜湖少量电缆能上门吗？", a: "可以先发图确认数量。少量项目可合并路线安排，整盘、整批、工厂拆除项目更适合单独上门。" },
      { q: "旧电缆和工地余料报价一样吗？", a: "不一样。未使用余料一般按接近新线状态评估，拆除旧线还要看护套、铠装、污染、剥离难度和现场清运成本。" },
    ],
  },
  {
    slug: "guides/anhui-transformer-recycling",
    title: "安徽二手变压器回收估价_合肥芜湖滁州干式油浸变压器 | 新兴电力设备",
    h1: "安徽二手变压器回收估价",
    desc: "安徽二手变压器回收估价主要看铭牌、容量、品牌、出厂年份、油浸或干式类型、绕组完整度、外观状态和是否带开关柜、箱变、电缆等配套设备。",
    kw: ["安徽二手变压器回收","合肥二手变压器回收","芜湖变压器回收","滁州变压器回收","安徽干式变压器回收","安徽油浸式变压器回收"],
    service: "二手变压器回收",
    serviceUrl: "/transformer-recycling/",
    sections: [
      {
        h2: "安徽变压器回收估价资料清单",
        lead: "先发资料可以减少无效上门，也能避免把仍有流通价值的设备按废料处理。",
        grid: [
          ["铭牌", "拍清型号、容量、电压等级、厂家、出厂日期和编号。"],
          ["外观", "拍变压器正面、侧面、接线端、油箱或干式绕组，以及是否漏油破损。"],
          ["状态", "说明是否仍在运行、停用多久、是否有检测报告或维修记录。"],
          ["配套", "是否带高低压柜、箱体、母线槽、电缆和基础附件，整套价值更好判断。"],
        ],
      },
      {
        h2: "安徽常见回收场景",
        lead: "安徽制造业园区里，变压器回收常和配电房改造、厂房搬迁、产线扩建一起发生。",
        grid: [
          ["合肥", "新能源汽车、家电、新型显示、集成电路工厂扩容或老设备替换。"],
          ["芜湖", "汽车及零部件、机器人、智能装备项目的配电房升级。"],
          ["马鞍山", "钢铁配套、机械加工、港口物流企业变电站改造。"],
          ["滁州", "家电、轨交装备、电子加工企业退租、扩产或设备更新。"],
        ],
      },
    ],
    faq: [
      { q: "安徽二手变压器回收是按废铁价吗？", a: "不是。铭牌完整、年限较近、容量常规、状态好的设备，应先按二手流通价值评估；无法继续使用的再按残值处理。" },
      { q: "没有检测报告还能回收吗？", a: "可以，但需要现场看外观、铭牌、运行状态和配套资料。若设备较新，建议补做检测以提高流通价值。" },
      { q: "箱式变电站可以整套回收吗？", a: "可以。可按整套箱变评估，也可拆分为变压器、高低压柜、箱体、电缆分别估价。" },
    ],
  },
  {
    slug: "guides/anhui-factory-demolition",
    title: "安徽工厂拆除设备处理流程_配电房电缆变压器打包回收 | 新兴电力设备",
    h1: "安徽工厂拆除设备处理流程",
    desc: "安徽工厂搬迁、园区腾退、配电房拆改时，可将废旧电缆、二手变压器、开关柜、配电柜、母线槽、电机水泵等设备打包评估处理，流程包括踏勘、清点、断电、拆除、装车、过磅和结算。",
    kw: ["安徽工厂拆除设备处理","合肥工厂设备回收","芜湖配电房拆除回收","马鞍山工厂拆除回收","滁州工厂搬迁设备回收","安徽整厂设备回收"],
    service: "工厂拆除设备处理",
    serviceUrl: "/factory-demolition/",
    sections: [
      {
        h2: "安徽工厂设备拆除先做清单",
        lead: "整厂或配电房项目最怕范围不清。先列清楚哪些设备回收、哪些保留、哪些需要专业拆除。",
        grid: [
          ["电气设备", "变压器、开关柜、配电柜、控制柜、母线槽、UPS 等。"],
          ["线缆线路", "高压电缆、低压动力电缆、控制电缆、桥架和管廊旧线。"],
          ["机电设备", "电机、水泵、风机、空压机及可拆金属附件。"],
          ["现场条件", "车辆进出、吊装叉车、楼层、限时施工、安全隔离和装车距离。"],
        ],
      },
      {
        h2: "适合打包评估的项目",
        lead: "只处理单个品类不一定最高效。配电房、车间、整厂腾退通常适合打包估价。",
        grid: [
          ["配电房改造", "旧变压器、高低压柜、母线槽、电缆一次性清点。"],
          ["园区退租", "限期清场时，需要拆除、装车、过磅和场地清理同步推进。"],
          ["产线搬迁", "保留设备和回收设备分开标记，减少误拆和漏拆。"],
          ["资产处置", "按企业要求提供交接清单、过磅单、现场照片和结算凭证。"],
        ],
      },
    ],
    faq: [
      { q: "安徽整厂设备回收可以先远程估价吗？", a: "可以先发设备清单、现场照片、配电房照片和所在城市，先判断项目规模与大致处理方式，再安排上门踏勘。" },
      { q: "拆除前需要企业断电吗？", a: "需要企业或电力维保方配合确认停电、验电、挂牌和安全边界，回收方再按范围拆除清运。" },
      { q: "工厂设备处理能开单据吗？", a: "可在项目确认前约定交接清单、过磅单、结算凭证和票据要求，实际内容以合同及交易主体条件为准。" },
    ],
  },
];
...
const commonFaqs = [
  { q: "废旧电缆回收价格怎么算？",       a: "按材质、规格、重量、成色、拆卸清运难度和当日金属行情综合评估。铜芯与铝芯价格差异较大，建议拍照发微信，收到资料后再给出初步价格范围。" },
  { q: "二手变压器回收需要哪些信息？",   a: "铭牌照片（型号、容量、电压、厂家、出厂日期）+ 外观实景图 + 台数。根据品牌、容量、使用年限与外观状态给出初步收购意向。" },
  { q: "工厂搬迁整体设备能一起处理吗？", a: "可以先清点变压器、开关柜、母线槽、电机水泵、控制柜和电缆线路，再根据现场条件制定打包评估与场地腾退方案。" },
];
function cityLocalFaqs(c) {
  return [
    { q:`在${c.name}多久能安排上门？`,
      a:`可先提供${c.name}具体位置、设备照片、数量和装车条件，再根据${c.areas.slice(0,3).join("、")}等区域的路线与当前排期确认上门时间。` },
    ...
    { q:`${c.name}常见项目场景有哪些？`,
      a:`${c.caseNote}具体报价、施工和清运安排仍以现场核实及双方约定为准。` },
  ];
}
...
<main>
  <section class="hero"><div class="wrap">
    ...
    <span class="chip chip-amber">● ${c.name} · 预约上门</span>
    <h1>${c.name}<em>废旧电缆回收</em><br/>· 二手变压器回收出售</h1>
    <p>新兴电力设备服务${c.prov}${c.name}区域，为本地工厂、物业、电气承包商提供废旧电缆回收、二手变压器回收与出售、整厂拆除设备处理。覆盖${c.areas.join("、")}等${c.name}主要工业区，符合条件的项目可预约上门，现场核对并说明报价依据。</p>
    <div>
      ${["✓ 预约上门评估","✓ 报价依据说明","✓ 现场核对","✓ 单据按约提供"].map(x=>`<span class="chip">${x}</span>`).join("")}
    </div>
  ...
  <section id="case"><div class="wrap">
    <div class="kicker">Project Scenarios · ${c.name}</div>
    <h2>${c.name}常见项目场景</h2>
    <p class="bigp">${c.caseNote}</p>
    <p style="color:#71717a;font-size:13px;margin-top:8px">说明：以上为常见业务场景，具体设备状态、价格和清运方案需现场确认。</p>
  </div></section>

  <section id="regions"><div class="wrap">
    <div class="kicker">Local Coverage</div>
    <h2>${c.name}上门服务区域</h2>
    <p class="lead">以下区县/开发区可预约上门，具体时间根据项目位置、数量和当前排期确认。</p>
  ...
  <section><div class="wrap">
    <div class="contact-box">
      ...
      <p style="color:#a1a1aa;font-size:14px;margin:0">发送铭牌照片、数量和位置到微信 <strong style="color:#fcd34d">${WECHAT}</strong>，收到资料后可先判断设备类型和初步价格范围。</p>
...
<main>
  ...
  <section><div class="wrap">
    <div class="contact-box">
      ...
      <p style="color:#a1a1aa;font-size:14px;margin:0">发送铭牌照片、规格、数量和位置到微信 <strong style="color:#fcd34d">${WECHAT}</strong>，收到资料后可先判断是否需要现场评估。</p>
      <a href="${PHONE_TEL}" class="phone-big">📞 ${PHONE}</a>
      <div style="color:#71717a;font-size:12px">服务时段：每日 08:00–20:00 · 急单可协商</div>
    </div>
...
function renderSiteTxt() {
  return `${buildSeoUrls().map(u => u.loc).join("\n")}\n`;
}
...
writeFileSync(resolve(ROOT, "public", "site.txt"), renderSiteTxt(), "utf8");
...
console.log(`✓ public/site.txt (${total} URLs)`);
console.log(`\n生成完成：${cityCount} 个城市页 + ${cityTransformerCount} 个城市变压器页 + ${localTransformerCount} 个区县变压器页 + ${svcCount} 个业务中枢页 + ${guideCount} 个指南页 + sitemap / site.txt`);
